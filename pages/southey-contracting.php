...
<head>
    ...
    <meta name="description"
        content="Southey Contracting - Specialized mining and industrial contracting, maintenance, and skilled manpower supply services.">
    <title>Southey Contracting | Ensol Group</title>
...
<body>
    ...
    <section class="subsidiary-hero">
        ...
        <img src="../assets/Southey_logo_background.jpeg" alt="Southey Contracting" class="subsidiary-hero-img">
        <div class="subsidiary-hero-content animate-on-scroll">
            <h1 class="subsidiary-hero-title">Southey Contracting</h1>
            <p class="hero-description" style="color: var(--white); font-size: 1.2rem;">Expert contracting and manpower supply for mining and industry.</p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="about-group-content">
                <div class="about-group-text animate-on-scroll">
                    <h2 class="section-title-left">About <span class="title-accent">Southey Contracting</span></h2>
                    <p>Southey Contracting has a long-standing reputation for delivering specialized contracting services in the mining and industrial sectors. As a key subsidiary of the Ensol Group, we bring extensive experience in managing complex projects, shutdowns, and maintenance operations.</p>
                    <p>We are also a leading provider of skilled manpower, ensuring our clients have access to the best certified professionals in the industry. Our focus on safety, efficiency, and quality makes us the preferred partner for major operators.</p>
                </div>
                <div class="story-image animate-on-scroll delay-2">
                    <img src="../assets/img3.jpeg" alt="Contracting Work">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="partners-grid" style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: var(--spacing-lg); margin-top: var(--spacing-lg); justify-content: center;">
                ...
                <div class="service-card animate-on-scroll" style="background: var(--white); padding: var(--spacing-lg); border-radius: var(--radius-lg); box-shadow: var(--shadow-md);">
                    ...
                    <h3 class="service-card-title">Access & Scaffolding Solutions</h3>
                    <p class="service-card-description">
                        We provide safe, reliable scaffolding systems that ensure easy access and support for
                        projects of any size while meeting industry safety standards.
                    </p>
                </div>
                ...
                <div class="service-card animate-on-scroll delay-1" style="background: var(--white); padding: var(--spacing-lg); border-radius: var(--radius-lg); box-shadow: var(--shadow-md);">
                    ...
                    <h3 class="service-card-title">Skilled Manpower Supply</h3>
                    <p class="service-card-description">
                        Provision of trained, certified personnel for industrial operations including technicians,
                        welders, riggers, and supervisors.
                    </p>
                </div>
    ...
    <section class="contact-section" style="background-color: var(--jet-black); color: var(--white); padding: var(--spacing-2xl) 0;">
        <div class="container" style="text-align: center;">
            ...
            <p class="animate-on-scroll width-100" style="max-width: 600px; margin: 0 auto var(--spacing-lg) auto;">
                Need reliable contracting services? Contact Southey Contracting today.
            </p>
            ...
            <div class="footer-content">
                ...
                <div class="footer-section footer-map animate-on-scroll delay-3">
                    ...
                    <div class="social-links">
                        <a href="https://www.linkedin.com/company/southdeycontractingltd/?viewAsMember=true" target="_blank" class="social-icon" aria-label="LinkedIn">
