    ...
    <section class="target-audience">
        <div class="container">
            <div class="target-audience-content">
                <div class="target-audience-text animate-on-scroll">
                    <h2 class="section-title-left">Target<br><span class="title-accent">Audience</span></h2>
                    <p>Ensol Group serves organizations in the oil and gas, energy, mining, and major construction
                        sectors, primarily in Ghana and across West Africa. Its clients are large-scale operators that
                        require reliable engineering, maintenance, inspection, and technology-driven services to
                        support safe, efficient, and sustainable operations.</p>
                    <p>As an indigenous Ghanaian company with integrated capabilities, Ensol appeals to senior
                        decision-makers by combining local expertise with world-class standards, innovation, and a
                        strong focus on long-term partnerships.</p>
                </div>
                <div class="target-audience-image animate-on-scroll delay-2">
                    <img src="../assets/target.jpg" alt="Target Audience">
                </div>
            </div>
        </div>
    </section>
